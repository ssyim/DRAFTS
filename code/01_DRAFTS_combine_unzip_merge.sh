...
# expects nextseq raw data, which means each folder has 2 files of R1 and R2 (paired-end reads)
# and files sequenced from different lanes of nextseq flowcells are separated in four different folders labeled with _L001 _L002 _L003 _L004
